...
{
    public class SchoolAdminRepository : Repository<SchoolAdmin>, ISchoolAdminRepository
    {
        public SchoolAdminRepository(ApplicationDbContext context) : base(context) { }
