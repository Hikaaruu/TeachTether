...
namespace TeachTether.API.Controllers
{
    ...
    public class StudentAttendancesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<StudentAttendanceResponse>>> GetAllByStudent(int studentId, int schoolId)
        {
            ...
            var authResult = await _authorizationService.AuthorizeAsync(User, studentId, new CanViewAttendancesOfStudentRequirement());
        ...
        public async Task<ActionResult<ClassGroupResponse>> Get(int studentId, int schoolId, int attendanceId)
        {
            var school = await _schoolService.GetByIdAsync(schoolId);
            var student = await _studentService.GetByIdAsync(studentId);
            ...
            var authResult = await _authorizationService.AuthorizeAsync(User, attendanceId, new CanViewStudentAttendanceRequirement());
