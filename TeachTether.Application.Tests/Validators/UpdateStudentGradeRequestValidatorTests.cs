...
public class UpdateStudentGradeRequestValidatorTests
{
    private readonly UpdateStudentGradeRequestValidator _sut = new();

    private static UpdateStudentGradeRequest CreateValidRequest() => new()
    {
        GradeValue = 85.50m,
        GradeType = "Quiz",
        Comment = null
