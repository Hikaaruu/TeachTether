...
public class UpdateStudentBehaviorRequestValidatorTests
{
    private readonly UpdateStudentBehaviorRequestValidator _sut = new();

    private static UpdateStudentBehaviorRequest CreateValidRequest() => new()
    {
        BehaviorScore = 7.50m,
        Comment = null
    };
    ...
    public void Should_NotHaveError_When_Comment_IsNonNull_AndValid()
    {
        // Arrange
        var model = CreateValidRequest();
        model.Comment = "Excellent participation.";
