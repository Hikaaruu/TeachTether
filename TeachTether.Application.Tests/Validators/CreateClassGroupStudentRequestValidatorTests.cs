...
public class CreateClassGroupStudentRequestValidatorTests
{
    private readonly CreateClassGroupStudentRequestValidator _sut = new();

    [Fact]
    public void Should_NotHaveErrors_When_StudentId_IsValid()
    {
        // Arrange
        var model = new CreateClassGroupStudentRequest { StudentId = 1 };
    ...
    {
        // Arrange
        var model = new CreateClassGroupStudentRequest { StudentId = 0 };
