...
public class CreateUserDtoValidatorTests
{
    ...
    [Fact]
    public void Should_NotHaveErrors_When_Email_IsNull()
    {
        // Arrange
        var model = CreateValidDto();
        model.Email = null;
    ...
    // --- Email (conditional: only validated when non-null) ---

    [Fact]
    public void Should_HaveError_When_Email_IsNonNull_AndEmpty()
    {
        // Arrange
        var model = CreateValidDto();
        model.Email = "";
    ...
    [Fact]
    public void Should_HaveError_When_Email_IsNonNull_AndHasInvalidFormat()
    {
        // Arrange
        var model = CreateValidDto();
    ...
    [Fact]
    public void Should_HaveError_When_Email_IsNonNull_AndExceedsMaxLength()
    {
        // Arrange
        var model = CreateValidDto();
