...
public class SchoolAdminService(
    ...
    ISchoolAdminDeletionHelper schoolAdminDeletionHelper) : ISchoolAdminService
{
    ...
    {
        var (user, password) = await _userService.CreateAsync(request.User, UserType.SchoolAdmin);
