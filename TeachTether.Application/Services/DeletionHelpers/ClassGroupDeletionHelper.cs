...
public class ClassGroupDeletionHelper(IUnitOfWork unitOfWork, IClassGroupsSubjectDeletionHelper subjectDeletionHelper)
    : IClassGroupDeletionHelper
{
    private readonly IClassGroupsSubjectDeletionHelper _classGroupsSubjectDeletionHelper = subjectDeletionHelper;
    ...
    public async Task DeleteClassGroupAsync(int id)
    {
        ...
        foreach (var cgs in cgSubjects) await _classGroupsSubjectDeletionHelper.DeleteClassGroupsSubjectAsync(cgs.Id);
