...
public class SubjectDeletionHelper(
    IUnitOfWork unitOfWork,
    IClassGroupsSubjectDeletionHelper classGroupsSubjectDeletionHelper) : ISubjectDeletionHelper
{
    private readonly IClassGroupsSubjectDeletionHelper _classGroupsSubjectDeletion = classGroupsSubjectDeletionHelper;
    ...
    public async Task DeleteSubjectAsync(int id)
    {
        ...
        foreach (var cgs in classGroupSubjects) await _classGroupsSubjectDeletion.DeleteClassGroupsSubjectAsync(cgs.Id);
