...
{
    public class StudentDeletionHelper : IStudentDeletionHelper
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IUserRepository _userRepository;

        public StudentDeletionHelper(IUnitOfWork unitOfWork, IUserRepository userRepository)
        {
        ...
        public async Task DeleteStudentAsync(int id)
        {
            ...
            if (cgStudent is not null)
            {
                _unitOfWork.ClassGroupStudents.Delete(cgStudent);
            }
