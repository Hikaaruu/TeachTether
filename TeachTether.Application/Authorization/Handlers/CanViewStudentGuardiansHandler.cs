...
{
    public class CanViewStudentGuardiansHandler : AuthorizationHandler<CanViewStudentGuardiansRequirement, int>
    {
        private readonly IUnitOfWork _unitOfWork;

        public CanViewStudentGuardiansHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, CanViewStudentGuardiansRequirement requirement, int studentId)
        {
