...
public class CanCreateThreadHandler(IUnitOfWork unitOfWork)
    : AuthorizationHandler<CanCreateThreadRequirement, (int, int)>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
        CanCreateThreadRequirement requirement, (int, int) resource)
    {
        ...
        switch (type)
        {
            ...
            case UserType.Teacher:
            {
                ...
                var isAssignedToClassGroup = await _unitOfWork.ClassAssignments
                    .AnyAsync(ca =>
                        classGroupSubjectIds.Contains(ca.ClassGroupSubjectId) && ca.TeacherId == currentTeacher.Id);
