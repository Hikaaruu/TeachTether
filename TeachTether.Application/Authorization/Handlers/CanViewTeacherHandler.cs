...
public class CanViewTeacherHandler(IUnitOfWork unitOfWork) : AuthorizationHandler<CanViewTeacherRequirement, int>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
        CanViewTeacherRequirement requirement, int teacherId)
    {
