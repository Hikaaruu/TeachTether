...
{
    public class CanViewSubjectHandler : AuthorizationHandler<CanViewSubjectRequirement, int>
    {
        private readonly IUnitOfWork _unitOfWork;

        public CanViewSubjectHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, CanViewSubjectRequirement requirement, int subjectId)
        {
