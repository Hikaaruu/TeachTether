...
{
    public class CanViewGuardianHandler : AuthorizationHandler<CanViewGuardianRequirement, int>
    {
        private readonly IUnitOfWork _unitOfWork;

        public CanViewGuardianHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, CanViewGuardianRequirement requirement, int guardianId)
        {
                ...
                case UserType.Teacher:
                    {
                        ...
                        var isAssignedToClassGroup = await _unitOfWork.ClassAssignments
                            .AnyAsync(ca => classGroupIds.Contains(ca.ClassGroupId) && ca.TeacherId == teacher.Id);
