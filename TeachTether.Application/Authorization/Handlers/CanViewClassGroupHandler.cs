...
public class CanViewClassGroupHandler(IUnitOfWork unitOfWork) : AuthorizationHandler<CanViewClassGroupRequirement, int>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
        CanViewClassGroupRequirement requirement, int classGroupId)
    {
