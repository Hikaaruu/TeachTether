...
{
    public class CanCreateStudentRecordsHandler : AuthorizationHandler<CanCreateStudentRecordsRequirement, (int, int)>
    {
        private readonly IUnitOfWork _unitOfWork;

        public CanCreateStudentRecordsHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, CanCreateStudentRecordsRequirement requirement, (int, int) resource)
        {
