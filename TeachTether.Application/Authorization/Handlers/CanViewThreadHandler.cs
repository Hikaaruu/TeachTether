...
public class CanViewThreadHandler(IUnitOfWork unitOfWork) : AuthorizationHandler<CanViewThreadRequirement, int>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
        CanViewThreadRequirement requirement, int threadId)
    {
