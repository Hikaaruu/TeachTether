...
{
    public class CanManageSchoolHandler : AuthorizationHandler<CanManageSchoolRequirement, int>
    {
        private readonly IUnitOfWork _unitOfWork;

        public CanManageSchoolHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, CanManageSchoolRequirement requirement, int schoolId)
        {
            ...
            if (school.SchoolOwnerId == schoolOwner.Id)
            {
