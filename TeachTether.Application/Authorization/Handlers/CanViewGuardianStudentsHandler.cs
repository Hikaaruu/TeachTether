...
public class CanViewGuardianStudentsHandler(IUnitOfWork unitOfWork)
    : AuthorizationHandler<CanViewGuardianStudentsRequirement, int>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
        CanViewGuardianStudentsRequirement requirement, int guardianId)
    {
