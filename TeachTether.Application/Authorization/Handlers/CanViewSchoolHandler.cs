...
public class CanViewSchoolHandler(IUnitOfWork unitOfWork) : AuthorizationHandler<CanViewSchoolRequirement, int>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
        CanViewSchoolRequirement requirement, int schoolId)
    {
