...
{
    public class CanViewAnnouncementHandler : AuthorizationHandler<CanViewAnnouncementRequirement, int>
    {
        private readonly IUnitOfWork _unitOfWork;

        public CanViewAnnouncementHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, CanViewAnnouncementRequirement requirement, int announcementId)
        {
                ...
                case UserType.Guardian:
                    {
                        ...
                        canView = allowedClassGroupIds.Any(x => classGroupIds.Contains(x)) &&
                            (announcement.TargetAudience == AudienceType.Guardian || announcement.TargetAudience == AudienceType.StudentAndGuardian);
                ...
                case UserType.Student:
                    {
                        ...
                        canView = allowedClassGroupIds.Contains(classGroupStudent.ClassGroupId) &&
                                                    (announcement.TargetAudience == AudienceType.Student || announcement.TargetAudience == AudienceType.StudentAndGuardian);
                        break;
                    }
