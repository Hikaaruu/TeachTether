...
public class CanViewClassAssignmentsHandler(IUnitOfWork unitOfWork)
    : AuthorizationHandler<CanViewClassAssignmentsRequirement, int>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context,
        CanViewClassAssignmentsRequirement requirement, int classGroupId)
    {
