...
public class JwtTokenGenerator(
    ...
    IUnitOfWork unitOfWork) : IJwtTokenGenerator
{
    ...
    public async Task<string> GenerateJwtTokenAsync(User user)
    {
        ...
        if (!string.IsNullOrWhiteSpace(user.MiddleName)) claims.Add(new Claim("middle_name", user.MiddleName));
        ...
        if (entityId != null) claims.Add(new Claim("entity_id", entityId));
